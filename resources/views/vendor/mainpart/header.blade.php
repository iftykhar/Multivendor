				...
				<nav class="navbar navbar-expand">
					...
					<div class="user-box dropdown">
						<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="{{ !empty(Auth::user()->profile_pic) ? asset('uploads/vendor/'.Auth::user()->profile_pic) : asset('uploads/vendor/vendor.jpg') }}" class="user-img" alt="user avatar">
						...
						<ul class="dropdown-menu dropdown-menu-end">
							...
							<li>
                                <form action="{{route('vendor.logout')}}" method="post">
                                    @csrf
                                    <button class="dropdown-item" href="#"><i class='bx bx-log-out-circle'></i><span>Logout</span></button>
                                </form>
