                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="post" action="{{ route('register')}}">
                                            ...
                                            <div class="form-group">
                                                <input required="" type="password" id="confirmed" name="password_confirmation" placeholder="Confirm password" />
                                                <x-input-error :messages="$errors->get('password_confirmation')" class="mt-2" />
                                            </div>
                                            <!--  -->
                                            <div class="payment_option mb-50">
                                                <div class="custome-radio">
                                                    <input class="form-check-input" required="" type="radio" name="role"  id="exampleRadios3" checked="" value="user" />
                                                ...
                                                <div class="custome-radio">
                                                    <input class="form-check-input" required="" type="radio" name="role"  id="exampleRadios4" checked="" value="vendor" />
                                            ...
                                            <div class="login_footer form-group mb-50">
                                                <div class="chek-form">
                                                    <div class="custome-checkbox">
                                                        <input class="form-check-input" type="checkbox" name="policy" id="exampleCheckbox12" value="" />
